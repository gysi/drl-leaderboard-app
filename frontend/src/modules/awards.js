...
// > 10
  "2025-season-bronze": {
    "asset": bronze,
    "tooltip": '\'25 Fall Season Bronze Contributor'
  },
// > 50
  "2025-season-silver": {
    "asset": silver,
    "tooltip": '\'25 Fall Season Silver Contributor'
  },
// > 100
  "2025-season-gold": {
    "asset": gold,
    "tooltip": '\'25 Fall Season Gold Contributor'
  },
// > 250
  "2025-season-diamond": {
    "asset": diamond,
    "tooltip": '\'25 Fall Season Diamond Contributor'
  }
}

const playerIdToAwardMap = {
  //gysi 5xx
  "547247576684373546": [awards['2024-season-diamond'], awards['2025-season-diamond']],
  //vgan 250
